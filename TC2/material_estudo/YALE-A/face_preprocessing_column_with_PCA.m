...
% Then, apply PCA to the columns of the data matrix X
...
%Dados=X; % Guarda matriz original

clear A An Img;

%%% APLICACAO DE PCA AOS DADOS PARA REDUCAO DE DIMENSIONALIDADE
%%% Pode-se usar a funcao PRINCOMP do Matlab/Octave
%%% para o mesmo fim

%tol = 0.95;  % porcentagem de variancia explicada
[Y L V Q]=myPCA(X,tol,1); % Aplica PCA nas imagens originais

K=50;  % no. de fatores
[W H] = nnmf(X,K); % Aplica NNMF nas imagens originais

%save yaleA_clean.dat H -ascii
%save yaleA_clean_rot.dat d -ascii
